...
namespace DataStructure
{
    public class SortedZeros
    {
        ...
        public int Divide(int dividend, int divisor)
        {
            ...
            // We need to convert both numbers to negatives. Also we count the number of negatives signs.
            int negative = 2;
            if (dividend > 0)
            {
                negative--;
             ...
             * The >= is bcos we're working in negatives. In essence, that piece of code is checking that we're
             * still nearer to 0 than we are to INT.MIN
             */
            ...
            /* In the second loop, we work out which powers of two fit in, by having highestDouble and highestPowerOfTwo repeatedly.
